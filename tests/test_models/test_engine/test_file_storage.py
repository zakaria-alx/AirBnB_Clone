...
STORE_FILE_NAME = "object_instances.json"
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_save_file_exists(self):
        ...
        """
        self.storage.save()
        self.assertTrue(os.path.isfile(STORE_FILE_NAME))
    ...
    def test_save_file_read(self):
        ...
        with open(STORE_FILE_NAME, encoding="UTF8") as fd:
